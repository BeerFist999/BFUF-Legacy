...
function Player:Create()
    ...
    root.contentContainer = CreateFrame("Frame", nil, root)
    root.contentContainer:SetFrameLevel(rootLevel + 2)

    root.background = root.contentContainer:CreateTexture(nil, "BACKGROUND", nil, 0)
    root.background:SetColorTexture(0, 0, 0, .8)
    root.border = createBorder(root)

    root.portraitContainer = CreateFrame("Frame", nil, root.contentContainer)
    root.portraitContainer:SetFrameLevel(rootLevel + 3)
    root.portraitContainer:SetClipsChildren(true)
    root.barsContainer = CreateFrame("Frame", nil, root.contentContainer)
    root.barsContainer:SetFrameLevel(rootLevel + 3)
    root.textContainer = CreateFrame("Frame", nil, root.barsContainer)
    root.textContainer:SetFrameLevel(rootLevel + 5)
    root.statusIconsContainer = CreateFrame("Frame", nil, root.contentContainer)
    root.statusIconsContainer:SetFrameLevel(rootLevel + 5)
    root.classResourceContainer = CreateFrame("Frame", nil, root.contentContainer)
    root.classResourceContainer:SetFrameLevel(rootLevel + 5)
    root.overlayContainer = CreateFrame("Frame", nil, root.contentContainer)
